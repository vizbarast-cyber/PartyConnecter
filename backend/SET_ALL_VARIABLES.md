# 🔧 Set All Railway Variables - Copy & Paste

## Quick Setup Commands

Run these commands from the `backend` directory after linking to Railway:
...
# MongoDB (⚠️ YOU NEED TO SET THIS - Get from MongoDB Atlas)
...
## ⚠️ Don't Forget MongoDB!

You still need to set `MONGODB_URI`. Get it from MongoDB Atlas:
...
3. **Test**: `curl https://poetic-light-production.up.railway.app/api/health`
